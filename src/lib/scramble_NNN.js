...
export const scrambler444 = generate_NNN_scrambler(4, 40, true);
export const scrambler555 = generate_NNN_scrambler(5, 60, true);
export const scrambler666 = generate_NNN_scrambler(6, 70, true);
export const scrambler777 = generate_NNN_scrambler(7, 100, true);
